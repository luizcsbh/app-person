...

{
    ...
    public function rules()
    {
        return [
            ...
            'st_data_demissao' => 'sometimes|nullable|date|after_or_equal:st_data_admissao',
    ...
    public function messages()
    {
        return [
            ...
            'se_matricula.max'                  => 'A matrícula deve ter no máximo 20 caracteres.',
            'se_matricula.unique'               => 'Esta matricula já está cadastrado.',

            'pes_data_nascimento.sometimes' => 'A data de nascimento é obrigatória.',
